...
def test_frequent_words_by_class_in_cluster(dummy_df, dummy_encodings, dummy_clusters):
    ...
    freq_words_by_class = frequent_words_by_class_in_cluster(freq_words, dummy_encodings, cluster_text, cluster_text_labels)

    expected_output = {"testing": {"total": 2, "0": 2, "1": 0}, "row": {"total": 2, "0": 2, "1": 0}}
